(function () {
    ...
    function applyStockParamsFromUrl() {
        ...
        const rangeInput = qs('[data-filter="range"]');
        const yearInput = qs('[data-filter="year"]');
        const priceInput = qs('[data-filter="price"]');
        const sortInput = qs('[data-filter="sort"]');
    ...
    function syncHomeSearchForm() {
        const form = qs("[data-home-search-form]");
        ...
        form.addEventListener("submit", event => {
            ...
            ["search", "range", "year", "price"].forEach(key => {
            ...
            window.location.href = query ? `pages/stock?${query}` : "pages/stock";
        });
    }
